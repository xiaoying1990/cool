...
%{
  ...
  for the location of tokens */
    ...
    */
    ...
    expr_list2
    : expr ';'             { $$ = single_Expressions($1); }
    | expr_list2 expr ';'  { $$ = append_Expressions($1,single_Expressions($2)); }
    | error ';'            { yyclearin; }
    | expr_list2 error ';' { yyclearin; }
    ;
    ...
    | OBJECTID ':' TYPEID ASSIGN expr ',' let_expr 
                           { $$ = let($1,$3,$5,$7); }
    | error IN expr        { yyclearin; }
    | error ',' let_expr   { yyclearin; }
    ;
